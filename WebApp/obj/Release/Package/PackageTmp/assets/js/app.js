...
.controller("NavbarCtrl", function(userSvc, profileSvc, $scope, $state) {    
    ...
    $scope.profile = profileSvc.instance();
...
.controller("NourishmentCtrl", function (userSvc, nutritionSvc, profileSvc, sessionStoreSvc, mealTimeSvc, $scope, $log) {
    ...
    $scope.editGripRow = function (nourishment) {
